...
namespace ZeroDir {
    public static class MIME {
        static Dictionary<string, string> ConvertEnumToDictionary<TEnum>() where TEnum : Enum {
        ...
        public static Dictionary<string,string> get_MIME_dict() => MIME.ConvertEnumToDictionary<MIME.MimeTypes>();
